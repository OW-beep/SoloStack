...
export const categories = [
  {
    slug: "getting-paid",
    name: "Getting Paid",
    seoTitle: "Getting Paid as a Freelancer (2026): Invoicing, Payments & Tax Software Reviews",
...
What we compare on: real fee structures (including the currency markup that's often bigger than the advertised transfer fee), what a free tier actually excludes rather than just whether one exists, and how well a tool holds up specifically for cross-border freelance work rather than a domestic small business.
  ...
  },
  {
    ...
    seoTitle: "Staying Organized as a Freelancer (2026): Project, CRM & Password Tools Reviewed",
...
What we compare on: whether a genuinely usable free tier exists for solo use (not just a capped trial), how much setup time a tool demands before it's useful, and whether pricing scales sensibly as you occasionally bring on a subcontractor rather than assuming a full team from day one.
  ...
  },
  {
    ...
    seoTitle: "Winning Freelance Clients (2026): Portfolio, Proposal & Marketplace Tools Reviewed",
...
What we compare on: how fast a tool gets you from nothing to something usable (a portfolio that never launches helps no one), whether pricing punishes solo use the way per-seat models often do, and where a platform's cut or fee structure changes the actual math of using it.
  ...
  },
  {
    slug: "ai-stack",
    name: "AI Stack",
    seoTitle: "Best AI Tools for Freelancers (2026): Writing, Meetings & Image Generation Compared",
...
What we compare on: how a tool performs specifically on long, client-facing work rather than short demo prompts, what a genuinely usable free tier looks like in a category where pricing changes often, and — where relevant — what a tool's approach means for client trust and privacy, not just for you.
  ...
  },
  {
    slug: "guides",
    name: "Guides",
    seoTitle: "Freelance Software Buying Guides (2026): Pricing, Rates & Decision Checklists",
...
We keep this section small and add to it deliberately, not as a place to pad out content. If a genuinely reusable framework or checklist doesn't exist yet for a decision freelancers regularly face, it belongs here; if it's really just "here's a comparison of five tools," it belongs in one of the other categories instead.
  ...
  },
  {
    slug: "freelance-life",
    name: "Freelance Life",
    seoTitle: "Freelance Life (2026): The Psychology of Working Alone, Backed by Research",
    tagline: "Not tool comparisons — the psychological and practical realities of working alone, grounded in actual research rather than generic pep talks.",
    description: `
Most freelance advice about the harder emotional parts of the work — self-doubt, isolation, burnout — reads like a pep talk: reassurance without much underneath it. This section takes a different approach. Each piece starts from a genuinely common freelance experience and works through what actual research (psychology, behavioral science, published surveys) has to say about it, rather than repeating generic encouragement.

This isn't tool comparison content, and it isn't clinical advice. We're not a substitute for a therapist, a doctor, or a financial advisor, and we say so directly wherever it's relevant. What we try to do is take a feeling that's common enough to have a name and some actual research behind it, and explain what's known, where it comes from, and what the evidence says genuinely helps — with citations, not just assertions.

What we compare on: nothing, really — there's no "best pick" in this section. The standard instead is whether a claim is backed by something more solid than a blog post repeating another blog post, and whether we've been honest about what the research does and doesn't establish.
    `,
  },
];
